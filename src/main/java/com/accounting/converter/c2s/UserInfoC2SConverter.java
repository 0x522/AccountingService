...
public class UserInfoC2SConverter
    ...
    @Override
    protected com.accounting.model.service.UserInfo doForward(@NotNull UserInfo userInfo) {
    ...
    @Override
    protected UserInfo doBackward(@NotNull com.accounting.model.service.UserInfo userInfo) {
